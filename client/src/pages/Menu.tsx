                                        ...
                                        {filteredItems
                                            ...
                                            .map((item) => {
                                                ...
                                                return (
                                                    <div
                                                        key={item._id}
                                                        className={`${item.isRecommended ? 'bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-200 border-2' : 'bg-white border-gray-200'} rounded-xl shadow-sm border p-4 hover:shadow-md transition-shadow relative`}
